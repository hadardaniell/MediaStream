...
Environment variables (create a .env file in the project root), and put the following in the .env file:

MONGO_URI – MongoDB connection string

OMDB_API_KEY – This will allow Syncing IMDB Rating into contents given that the title and the release year match to IMDB  
...
**server/ – Node.js + Express backend**
  ...
  services/ – auxiliary services (if present), Currently includes the Rating <> IMDB Service
